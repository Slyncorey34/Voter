...
// // }
//
// function Voter(theName, theEmail, theScore, quizScores){
//   this.name = theName;
//   this.email = theEmail;
//   this.quizScores = [];
//   this.libVal = 0%;
//   this.conVal = 0%;
//   this.score = [libVal, conVal];
// }
//
// Voter. prototype = {
//   constructor: Voter,
...
//     var scores= this.quizScores.length > 0 ? this.quizScores.join(","): "nothing submitted yet";
//       return voter.name + "Scores: "  + scores;
//   },
// }
//   saveScore:function(theScoreToAdd){
//     this.quizScores.push(theScoreToAdd)
